...
public class DescriptionBasedDiffTest extends CompilerBasedTest {
  ...
  private DescriptionBasedDiff createDescriptionBasedDiff() {
    return DescriptionBasedDiff.create(compilationUnit, ImportOrganizer.DEFAULT_IMPORT_ORGANIZER);
  }
  ...
  public void overlappingDiffs_throws() {
    ...
    DescriptionBasedDiff diff3 = DescriptionBasedDiff.createIgnoringOverlaps(
        compilationUnit, ImportOrganizer.DEFAULT_IMPORT_ORGANIZER);
    diff3.onDescribed(
        new Description(
            null,
            "bah",
